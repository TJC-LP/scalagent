...
private[scalagent] object SdkModule extends js.Object:
  ...
  def getSessionInfo(sessionId: String, options: js.UndefOr[js.Dynamic] = js.undefined)
    : js.Promise[js.UndefOr[js.Dynamic]]                                                                     = js.native
  def forkSession(sessionId: String, options: js.UndefOr[js.Dynamic] = js.undefined): js.Promise[js.Dynamic] = js.native
  def listSubagents(sessionId: String, options: js.UndefOr[js.Dynamic] = js.undefined)
    : js.Promise[js.Array[js.Dynamic]] = js.native
